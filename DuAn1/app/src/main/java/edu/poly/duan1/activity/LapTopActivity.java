...
import edu.poly.duan1.adapter.LaptopAdapter;
...
//                Log.d("TAG", "totalItemCount: " + firstVisibleItem);
    ...
    public class ThreadData extends Thread {
        ...
        public void run() {
            ...
            try {
                ThreadData.sleep(3000); // ngủ 3 giây
    ...
    private void GetData(int page) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, link, new Response.Listener<String>() {
                ...
                if(response != null &&  response.length() != 2) {
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            listLaptop.add(new SanPham(id, tenSp, giaSp, anhSp, moTaSp, idSp));
                    ...
                    limitdata = true;
                    lvLaptop.removeFooterView(footerView); // nếu có dữ liệu thì tắt
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("idsanpham", String.valueOf(idLaptop)); // cùng với key trong php
                return param;
            }
        };
    ...
    private void AnhXaView() {
        ...
        adapter = new LaptopAdapter(this, listLaptop);
